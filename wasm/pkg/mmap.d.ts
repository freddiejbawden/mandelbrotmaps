...
* @returns {number} 
*/
  render_range(x_rect: any, y_rect: any, delta_x: number, delta_y: number, start_row: number, end_row: number, width: number, height: number, centre_coords_x: number, centre_coords_y: number): number;
/**
